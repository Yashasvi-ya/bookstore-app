...
=======
    // <div>
    //   {currentUser && (
    //     <div classNameName="h-screen w-full flex flex-col justify-center items-center">
    //       <div classNameName="h-1/2 w-1/4 flex flex-col justify-center items-center">
    //         <div classNameName=" h-full w-full rounded-lg p-3 flex flex-col justify-center items-center shadow-2xl">
    //           <h1 classNameName="text-3xl font-mono font-bold"> Profile </h1>
    //           <div classNameName="w-1/2 h-1/2 flex justify-center items-center">
    //             <CgProfile classNameName="h-full w-1/2"/>
    //           </div>
    //           <h1 classNameName="text-3xl font-bold text-gray-900">
    //             {currentUser.username}
    //           </h1>
    //           <h1 classNameName="text-xl font-semibold">{currentUser.email}</h1>
    //         </div>
    //       </div>
    //     </div>
    //   )}
...
<div className="p-4">
    <div className="mb-4 text-center opacity-90">
          <CgProfile/>
>>>>>>> a027b53fbac362d19005e28c84f7f2d98b7a774b
    </div>
